...
def get_encrypted_strings():
    ...
    for v in labels:
        ...
        encrypted = sub_classes.iloc[0][0]
...
def get_yolo_coordinate():
    ...
    global encrypted_strings
    global r
    # Adding new empty columns to store yolo coordinate
    sub_ann['classNumber'] = ''
    sub_ann['center x'] = ''
    sub_ann['center y'] = ''
    sub_ann['width'] = ''
